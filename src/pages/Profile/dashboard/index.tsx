...
import { getAllFollowers, getAllFollowings, handleUpload } from "../../../helpers/api";
...
export function Profile() {
  ...
  getAllFollowers()
  .then(response => {
    setFollowers(response.payload.length);
  })
  getAllFollowings()
  .then(response => {
    setFollowings(response.payload.length);
  })
            ...
            <MDBCard>
              ...
              >
                <div className="d-flex justify-content-end text-center py-1">
                  ...
                  <div>
                    <MDBCardText className="mb-1 h5">{followings}</MDBCardText>
                    <MDBCardText className="small text-muted mb-0">
                      Following
                    </MDBCardText>
                  </div>
